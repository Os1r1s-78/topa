...
#   c) node1 mines 32 blocks, so now node 0 has 60001topa, node 1 has 4250topa, node2 has none.
#   d) node0 sends 601 topa to node2, in two transactions (301 topa, then 300 topa).
