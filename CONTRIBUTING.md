Contributing to TopaChain Core
============================

The TopaChain Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TopaChain Core project, and is not to be
confused with overall TopaChain Network Protocol consensus changes.

Whether a pull request is merged into TopaChain Core rests with the project merge
...
Patches that change TopaChain consensus rules are considerably more involved than
...
Where a patch set proposes to change the TopaChain consensus, it must have been
...
The project leader is the release manager for each TopaChain Core release.
