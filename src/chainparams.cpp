...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 10 * 30;  // TopaChain POW not so fast as we can
        nTargetSpacing =  1 * 30; // TopaChain 30 seconds block time
        nMaturity = 180;
 ...
 */
        ...
        vSeeds.push_back(CDNSSeedData("dns", "nodes.topachain.com"));
