...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TopaChain Core"),
     ...
     * override -datadir in the topachain.conf file in the default data directory
     * (to be consistent with topachaind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
