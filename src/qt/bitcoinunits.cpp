...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(TOPA);
    unitlist.append(mTOPA);
    unitlist.append(uTOPA);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case TOPA:
        return QString("topachain");
    case mTOPA:
        return QString("mtopachain");
    case uTOPA:
        return QString::fromUtf8("utopachain");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case TOPA:
            return QString("TOPA");
        case mTOPA:
            return QString("mTOPA");
        case uTOPA:
            return QString::fromUtf8("μTOPA");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case TOPA:
            return QString("tTOPA");
        case mTOPA:
            return QString("mtTOPA");
        case uTOPA:
            return QString::fromUtf8("μtTOPA");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case TOPA:
            return QString("TOPA");
        case mTOPA:
            return QString("Milli-TOPA (1 / 1" THIN_SP_UTF8 "000)");
        case uTOPA:
            return QString("Micro-TOPA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case TOPA:
            return QString("TestTOPAs");
        case mTOPA:
            return QString("Milli-TestTOPA (1 / 1" THIN_SP_UTF8 "000)");
        case uTOPA:
            return QString("Micro-TestTOPA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
