                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strztopaPathCustom = GetArg("-ztopabackuppath", "");
    ...
    if(!strztopaPathCustom.empty()) {
        ui->wallet_customztopabackuppath->setText(QString::fromStdString(strztopaPathCustom));
        ui->wallet_customztopabackuppath_label->setVisible(true);
        ui->wallet_customztopabackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strztopaPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the TopaChain RPC console.") + "<br>" +
