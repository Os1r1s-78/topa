 ...
 */
    ...
    typeWidget->addItem(tr("Received Topa from zTopa"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTopa"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTopa));
