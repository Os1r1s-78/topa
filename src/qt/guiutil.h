...
/** Utility functions used by the TopaChain Qt UI.
 */
namespace GUIUtil
{
...
// Render TopaChain addresses in monospace font
...
// Parse "topachain:" URI into recipient object, return true on successful parsing
