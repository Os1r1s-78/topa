                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TopaChain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TopaChain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and topachain: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTOPA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TopaChain Core"), this);
    aboutAction->setStatusTip(tr("Show information about TopaChain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TopaChain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TopaChain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TopaChain addresses"));
    ...
    openAction->setStatusTip(tr("Open a TopaChain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TopaChain Core help message to get a list with possible TopaChain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TopaChain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TopaChain network", "", count));
}
...
{
    QString strTitle = tr("TopaChain Core"); // default title
