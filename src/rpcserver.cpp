...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop TopaChain server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "TopaChain server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TopaChain features */
        {"topachain", "masternode", &masternode, true, true, false},
        {"topachain", "listmasternodes", &listmasternodes, true, true, false},
        {"topachain", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"topachain", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"topachain", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"topachain", "getmasternodecount", &getmasternodecount, true, true, false},
        {"topachain", "masternodeconnect", &masternodeconnect, true, true, false},
        {"topachain", "masternodecurrent", &masternodecurrent, true, true, false},
        {"topachain", "masternodedebug", &masternodedebug, true, true, false},
        {"topachain", "startmasternode", &startmasternode, true, true, false},
        {"topachain", "createmasternodekey", &createmasternodekey, true, true, false},
        {"topachain", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"topachain", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"topachain", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"topachain", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"topachain", "getmasternodescores", &getmasternodescores, true, true, false},
        {"topachain", "mnbudget", &mnbudget, true, true, false},
        {"topachain", "preparebudget", &preparebudget, true, true, false},
        {"topachain", "submitbudget", &submitbudget, true, true, false},
        {"topachain", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"topachain", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"topachain", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"topachain", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"topachain", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"topachain", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"topachain", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"topachain", "checkbudgets", &checkbudgets, true, true, false},
        {"topachain", "mnsync", &mnsync, true, true, false},
        {"topachain", "spork", &spork, true, true, false},
        {"topachain", "getpoolinfo", &getpoolinfo, true, true, false},
        {"topachain", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getztopaseed", &getztopaseed, false, false, true},
        {"zerocoin", "setztopaseed", &setztopaseed, false, false, true}
...
{
    return "> topachain-cli " + methodname + " " + args + "\n";
}
