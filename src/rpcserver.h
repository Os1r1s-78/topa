...
/**
 * TopaChain RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setztopaseed(const UniValue& params, bool fHelp);
extern UniValue getztopaseed(const UniValue& params, bool fHelp);
