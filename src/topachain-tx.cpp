...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TopaChain Core topachain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  topachain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded topachain transaction") + "\n" +
                               "  topachain-tx [options] -create [commands]   " + _("Create hex-encoded topachain transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded topachain transaction
