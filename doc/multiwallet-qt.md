...
In order to support loading of multiple wallets in topachain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is topachain.cpp.
...
Changes to topachain.cpp
----------------------
topachain.cpp is the entry point into topachain-qt, and as such, will require some minor modifications to provide hooks for
