...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/topachain-cli.cpp \
           src/topachain-tx.cpp \
           src/topachain.cpp \
           src/db.cpp \
           ...
           src/qt/topachain.cpp \
           src/qt/topachainstrings.cpp \
...
RESOURCES += src/qt/topachain.qrc src/qt/topachain_locale.qrc

TRANSLATIONS += src/qt/locale/topachain_bg.ts \
                src/qt/locale/topachain_de.ts \
                src/qt/locale/topachain_en.ts \
                src/qt/locale/topachain_es.ts \
                src/qt/locale/topachain_fi.ts \
                src/qt/locale/topachain_fr.ts \
                src/qt/locale/topachain_it.ts \
                src/qt/locale/topachain_ja.ts \
                src/qt/locale/topachain_pl.ts \
                src/qt/locale/topachain_pt.ts \
                src/qt/locale/topachain_ru.ts \
                src/qt/locale/topachain_sk.ts \
                src/qt/locale/topachain_sv.ts \
                src/qt/locale/topachain_vi.ts \
                src/qt/locale/topachain_zh_CN.ts \
                src/qt/locale/topachain_zh_TW.ts
